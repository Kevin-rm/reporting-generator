...
' Normes sur les num�ros des erreurs :
' - � partir de 800 pour celles destin�es aux utilisateurs
' - � partir de 700 pour les erreurs internes et autres

Public generatedPassword As String

' Coordonn�es de la cellule \"B04 livr�es\"
